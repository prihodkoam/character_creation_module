...
def attack(char_name: str, char_class: str) -> str:
    """Функция принимает имя и класс игрока и возвращает наносимый урон."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция принимает имя и класс игрока и возвращает защиту."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция принимает имя и класс игрока и возвращает магию."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция принимает имя и класс игрока и запускает тренировку."""
    if char_class == 'healer':
...
def choice_char_class() -> str:
    """Функция для выбора класса игрока."""
    approve_choice: str = ''
    char_class: str = ''
